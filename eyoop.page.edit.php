...
[BEGIN_SED]
File=plugins/eyoop/eyoop.page.edit.php
Version=100
Updated=2006-jul-25
Type=Plugin
Author=riptide
...
if ($a=='update')
  ...
  $usr['isadmin'] = (sed_import('rpageownerid','P','INT') == $usr['id']) ? TRUE : $usr['isadmin'];
...
$t->assign(array(
	...
	"PAGEEDIT_FORM_SEND" => "plug.php?e=eyoop&amp;a=update&amp;id=".$pag['page_id']."&amp;r=".$r,
	...
	"PAGEEDIT_FORM_OWNERID" => "<input type=\"text\" class=\"text\" name=\"rpageownerid\" value=\"".sed_cc($pag['page_ownerid'])."\" size=\"32\" maxlength=\"24\" READONLY />",
